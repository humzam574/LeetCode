class Solution:
    def nextBeautifulNumber(self, n: int) -> int:
        ...
        self.arr = [14444, 22333, 23233, 23323, 23332, 32233, 32323, 32332, 33223, 33232, 33322, 41444, 44144, 44414, 44441, 55555, 155555, 515555, 551555, 555155, 555515, 555551, 666666]
        def bt(rem, curr):
            if not rem:
